package language.vars.special ;
	...
	class VarArrayView extends VarArray {
		...
		override public function copy(_oSBloc:SBloc):VarObj {
			...
			return copyVarArrayView(_oArray );
		}		
					
		private function copyVarArrayView(_oCopy:VarFixeArray):VarObj {
			_oCopy.eType = eType;

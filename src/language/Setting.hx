...
class Setting 
{
	...
	public static var sShortName = "C~";
	public static var sName = "CWayv";
	...
	public static var sDestructorKeyword = "destructor"; 
	public static var sDestroyKeyword = "destroy"; 
	public static var sCopyKeyword = "copy";
